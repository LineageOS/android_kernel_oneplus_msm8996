...
struct mdss_livedisplay_ctx {
	...
	const uint8_t *adobe_rgb_off_cmds;
	const uint8_t *adobe_rgb_on_cmds;
	unsigned int adobe_rgb_off_cmds_len;
	unsigned int adobe_rgb_on_cmds_len;
